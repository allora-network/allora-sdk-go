...
func (c *ConsensusRESTClient) Params(ctx context.Context, req *consensustypes.QueryParamsRequest, opts ...config.CallOpt) (*consensustypes.QueryParamsResponse, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "while calling ConsensusRESTClient.Params")
	}
	return resp, nil
}
