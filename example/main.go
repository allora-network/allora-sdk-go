...
// 	stakingParams, _, err := client.Staking().Params(ctx, &stakingtypes.QueryParamsRequest{})
// 	if err != nil {
...
// 	stakingPool, _, err := client.Staking().Pool(ctx, &stakingtypes.QueryPoolRequest{})
// 	if err != nil {
...
// 	validators, _, err := client.Staking().Validators(ctx, &stakingtypes.QueryValidatorsRequest{
// 		Status: "",
...
// 		pool, _, err := client.Staking().Pool(ctx, &stakingtypes.QueryPoolRequest{})
// 		if err != nil {
...
// 	totalSupply, _, err := client.Bank().TotalSupply(ctx, &banktypes.QueryTotalSupplyRequest{
...
// 	syncStatus, _, err := client.Tendermint().GetSyncing(ctx, &cmtservice.GetSyncingRequest{})
// 	if err != nil {
...
// 	emissionsParams, _, err := client.Emissions().GetParams(ctx, &emissionstypes.GetParamsRequest{})
// 	if err != nil {
...
// 	_, _, err = client.Mint().Params(ctx, &minttypes.QueryServiceParamsRequest{})
// 	if err != nil {
...
// 	denomOwners, _, err := client.Bank().DenomOwners(ctx, &banktypes.QueryDenomOwnersRequest{
// 		Denom:      "uallo",
