...
// broadcastTxClient implements interfaces.TxClient. BroadcastTx and GetTx are
...
func (f *broadcastTxClient) BroadcastTx(ctx context.Context, req *txtypes.BroadcastTxRequest, opts ...config.CallOpt) (*txtypes.BroadcastTxResponse, error) {
	return f.broadcastFn(ctx, req, opts...)
}

func (f *broadcastTxClient) GetTx(ctx context.Context, req *txtypes.GetTxRequest, opts ...config.CallOpt) (*txtypes.GetTxResponse, error) {
	return f.getTxFn(ctx, req, opts...)
}

func (f *broadcastTxClient) GetBlockWithTxs(ctx context.Context, req *txtypes.GetBlockWithTxsRequest, opts ...config.CallOpt) (*txtypes.GetBlockWithTxsResponse, error) {
	panic("GetBlockWithTxs not implemented in broadcastTxClient")
}

func (f *broadcastTxClient) GetTxsEvent(ctx context.Context, req *txtypes.GetTxsEventRequest, opts ...config.CallOpt) (*txtypes.GetTxsEventResponse, error) {
	panic("GetTxsEvent not implemented in broadcastTxClient")
}

func (f *broadcastTxClient) Simulate(ctx context.Context, req *txtypes.SimulateRequest, opts ...config.CallOpt) (*txtypes.SimulateResponse, error) {
	panic("Simulate not implemented in broadcastTxClient")
}

func (f *broadcastTxClient) TxDecode(ctx context.Context, req *txtypes.TxDecodeRequest, opts ...config.CallOpt) (*txtypes.TxDecodeResponse, error) {
	panic("TxDecode not implemented in broadcastTxClient")
}

func (f *broadcastTxClient) TxDecodeAmino(ctx context.Context, req *txtypes.TxDecodeAminoRequest, opts ...config.CallOpt) (*txtypes.TxDecodeAminoResponse, error) {
	panic("TxDecodeAmino not implemented in broadcastTxClient")
}

func (f *broadcastTxClient) TxEncode(ctx context.Context, req *txtypes.TxEncodeRequest, opts ...config.CallOpt) (*txtypes.TxEncodeResponse, error) {
	panic("TxEncode not implemented in broadcastTxClient")
}

func (f *broadcastTxClient) TxEncodeAmino(ctx context.Context, req *txtypes.TxEncodeAminoRequest, opts ...config.CallOpt) (*txtypes.TxEncodeAminoResponse, error) {
	panic("TxEncodeAmino not implemented in broadcastTxClient")
}

var _ interfaces.TxClient = (*broadcastTxClient)(nil)
